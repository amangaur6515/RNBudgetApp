...
const budgetReducer=(state=initialState,action)=>{
    switch(action.type){
        case 'SAVE_BUDGET':
            ...
            // Find the month object in the state
        ...
        case 'GET_BUDGET':
            ...
            // Find the month object in the state
            const monthObject = state.find(m => m.month === monthName);

            // If month object is found, return its items array
            if (monthObject) {
                return monthObject.items;
            }

            // If month object is not found, return an empty array
            return [];
